...
await build({
    ...
    bundle: true,
    format: 'esm',
    outfile: '../PuertsAgent/Resources/LLMAgent/main.mjs',
...
const outPath = '../PuertsAgent/Resources/LLMAgent/main.mjs';
...
const builtinOutDir = '../PuertsAgent/Resources/LLMAgent/editor-assistant/builtins';
